...
gulp.task('build',
  gulp.series(clean, pages, sassTask, images, inline));
...
function sassTask() {
  return gulp.src('src/assets/scss/app.scss')
    ...
    .pipe(sass({ // Use the 'gulp-sass' package
...
function watch() {
  ...
  gulp.watch(['../scss/**/*.scss', 'src/assets/scss/**/*.scss']).on('all', gulp.series(resetPages, sassTask, pages, inline, browser.reload));
